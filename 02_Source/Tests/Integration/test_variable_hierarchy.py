...
class TestVariableHierarchy(RepositoryTestCase):

    def test_complete_variable_hierarchy(self):
        ...
        variable_repo = VariableRepository(self.conn)
        ...
        variable.id = variable_repo.create(variable)
        ...
        self.assertIsNotNone(variable_repo.get_by_id(variable.id))